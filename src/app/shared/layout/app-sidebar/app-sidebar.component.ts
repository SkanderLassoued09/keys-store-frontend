  ...
  navItems: NavItem[] = [
    {
      ...
      name: "Articles",
      subItems: [
        { name: "Add article", path: "/article" },
        { name: "List article", path: "/article-list" },
      ],
    },
    {
      ...
      name: "Machines",
      subItems: [
        { name: "Add machine", path: "/machine" },
        { name: "List machine", path: "/machine-list" },
      ],
    },
    {
      ...
      name: "Employees",
      subItems: [
        { name: "Add employee", path: "/employee" },
        { name: "List employee", path: "/employee-list" },
      ],
    },
    // {
    //   name: "Forms",
    ...
    // },
    {
      ...
      subItems: [
        { name: "Add Fourniseur", path: "/provider" },
        { name: "List Fourniseur", path: "/provider-list" },
      ],
    },
    {
      name: "Client",
      ...
      subItems: [
        { name: "Add client", path: "/client" },
        { name: "List client", path: "/client-list" },
      ],
    },
  ];
  // Others nav items
